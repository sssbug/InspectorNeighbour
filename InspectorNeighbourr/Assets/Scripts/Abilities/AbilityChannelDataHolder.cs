...
namespace Hel.Abilities
{
    ...
    public class AbilityChannelDataHolder : ScriptableObject
    {
        [SerializeField] private ChannelableEvent onStartedChanneling = null;
        [SerializeField] private ChannelableEvent onFinishedChanneling = null;
