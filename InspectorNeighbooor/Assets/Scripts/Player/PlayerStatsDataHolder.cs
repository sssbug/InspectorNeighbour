...
namespace Hel.Player
{
    ...
    public class PlayerStatsDataHolder : ScriptableObject, ISaveable
    {
        [Header("Events")]
         [SerializeField] private VoidEvent onPlayerHealthChanged = null;
         [SerializeField] private VoidEvent onPlayerManaChanged = null;
         [SerializeField] private VoidEvent onPlayerDied = null;
         [SerializeField] private VoidEvent onPlayerExperienceChanged = null;
         [SerializeField] private VoidEvent onPlayerLevelUp = null;
         [SerializeField] private VoidEvent onPlayerCurrenciesChanged = null;

        [Header("Data Holders")]
         [SerializeField] private StatsHolder defaultStats = null;
         [SerializeField] private CurrencyHolder defaultCurrencies = null;

        [Header("On Level Up")]
         [SerializeField] private Dictionary<Stat, StatModifier> levelUpStatChanges = new Dictionary<Stat, StatModifier>();
         [SerializeField] private Dictionary<Currency, int> levelUpCurrencyChanges = new Dictionary<Currency, int>();
