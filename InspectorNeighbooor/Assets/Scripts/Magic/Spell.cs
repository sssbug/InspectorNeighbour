...
namespace Hel.Magic
{
    ...
    public class Spell : HotbarItem, IUseable, ICooldownable, IChannelable
    {
        ...
        [SerializeField] private ElementTree elementTree = null;
        [SerializeField] private float maxCooldownDuration = 1f;
        [SerializeField] private float channelDuration = 1f;

        [Header("Spell Logic")]
         [SerializeField] private List<AbilityRequirement> abilityRequirements = new List<AbilityRequirement>();
