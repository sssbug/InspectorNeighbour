...
namespace Hel.Abilities
{
    ...
    {
        [SerializeField] private TargetGetter targetGetter = null;
        [SerializeField] private TargetGetterEvent onStartGettingTargets = null;
        [SerializeField] private VoidEvent onEndGettingTargets = null;
